...
import { createUserWithEmailAndPassword,signInWithEmailAndPassword } from 'firebase/auth'; // Importing createUserWithEmailAndPassword from Firebase auth
...
const [loading,setLoading]=useState(false)
    ...
    const isEmailValid = (email) => {
      ...
      const handleRegister = async (e) => {
        ...
        if (!avatar.file) {
          missingFields.push('Upload An Image');
        }
